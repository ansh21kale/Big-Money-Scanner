    ...
    with lock:
        for s in states.values():
            ...
            try:
                ...
                grouped[s.underlying].append(row)

            except Exception as exc:
                add_error(f"score: {exc}")
